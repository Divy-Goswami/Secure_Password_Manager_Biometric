...
// Create a PasswordCard component
    ...
    <div className="bg-gray-700 rounded-lg p-4 transition-all hover:bg-gray-600">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center">
          ...
          <span className="font-medium text-white">{entry.domain_name}</span>
        </div>
        <button
      ...
      <div className="flex items-center">
        <span className="font-mono bg-gray-800 px-2 py-1 rounded select-all text-sm">{entry.password}</span>
      </div>
    </div>
  );
};
  ...
  const handleOTPVerify = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setIsOTPVerified(true);
        setIsVerified(true);
        // Fetch passwords after verification
        fetchPasswords();
      } else {
        const data = await response.json();
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="glass-card p-8 animate-fadeIn">
            ...
            {/* Combined Success Screen - shows after successful verification */}
            {isVerified && (
              <div className="mt-6 bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                <div className="p-6 bg-gradient-to-r from-green-900/30 to-blue-900/30">
                  ...
                  <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-8">
                    ...
                    <div className="bg-gray-900/50 p-4 rounded-lg flex items-center w-full md:w-auto">
                      ...
                      <div>
                        ...
                        <p className="text-green-400 text-sm">{faceIdVerified ? "Verified" : "Skipped"}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-900/50 p-4 rounded-lg flex items-center w-full md:w-auto">
                      ...
                      <div>
                        <p className="text-white font-medium">OTP</p>
                  ...
                  <div className="text-center">
                    <div className="inline-block animate-bounce bg-green-500 p-2 rounded-full mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <h3 className="text-xl font-semibold text-white mb-2">All Set!</h3>
                    <p className="text-gray-300 mb-6">Access to your passwords has been granted.</p>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-700 p-6">
                  ...
                  {/* Password list will be displayed here */}
                  {passwords.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-400">No passwords found. Add passwords first.</p>
                      <button
                        onClick={() => router.push("/password/add")}
                        className="btn-modern btn-outline mt-4"
                      >
                        Add Password
                      </button>
                    </div>
